...
class PrescriptionServiceApplicationTests {
    ...
    @Test
//  the prescription retrieved with ID 1 should have the same attributes as the attributes entered above
    ...
    @Test
//    should return the correct number of prescriptions with the specific patient ID
    ...
    @Test
//    should return the correct number of prescriptions with the specific doctor ID
    ...
    @Test
//   should return the correct number of prescriptions with the medicine name
    ...
    @Test
//   the new prescription should be created and can be found in the database
